...
public class TimeLimitFragment extends Fragment implements View.OnClickListener {
    ImageView avatarImageView;
    Button startGameBtn;
    View gameBody;
    private CountDownTimer timer;

    private long DEFAULTTIME = 3*60_000;//初始倒计时
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_time_limit, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        startGameBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                gameBody.setVisibility(View.VISIBLE);
                startCountDown();
            }
        });
        //
    ...
    private void startCountDown() {
        remainingTimeMillis = DEFAULTTIME; // 60秒
        restartTimer();
    }

    private void restartTimer() {
        if (timer != null) timer.cancel();
        timer = new CountDownTimer(remainingTimeMillis, 1_000) {
            @Override
