...
import com.example.wordcrush.Database.GameRecordDatabase.GameRecordDao;
import com.example.wordcrush.Database.GameRecordDatabase.GameRecordEntity;
import com.example.wordcrush.Database.WordDatabse.WordDao;
import com.example.wordcrush.Database.WordDatabse.WordEntity;

@Database(entities = {WordEntity.class, GameRecordEntity.class}, version = 1, exportSchema = false)
